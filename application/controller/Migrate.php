...
class Migrate extends CI_Controller {
	...
	public function index()
	{
		...
		$data['assets'] = [
			'bootstrap_css' => base_url('assets/migrations/css/bootstrap.min.css'),
			'bootstrap_js'  => base_url('assets/migrations/js/bootstrap.min.js'),
			'jquery'        => base_url('assets/migrations/js/jquery-2.2.4.min.js'),
		];
